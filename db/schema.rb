...
ActiveRecord::Schema[8.0].define(version: 20_241_121_171_004) do
  ...
  create_table 'administration_tracking', force: :cascade do |t|
    ...
    t.string 'action'
    t.index %w[admin_id structure_type structure_id],
            name: 'idx_on_admin_id_structure_type_structure_id_75f645dcb5'
