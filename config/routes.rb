Rails.application.routes.draw do
  ...
  get '/jams/:id/jury_configuration', to: 'jams#jury_configuration', as: 'jury_configuration'
  patch '/jams/:id', to: 'jams#update', as: 'jam_update'
  delete '/jams/:id', to: 'jams#destroy', as: 'jam_destroy'
  patch '/jams/:id/jury_configuration', to: 'jams#host_list_update', as: 'host_list_update'
  get '/jams/:id/jury_configuration', to: 'jams#host_update', as: 'host_update'
  delete '/jams/:id/jury_configuration', to: 'jams#delete_user', as: 'delete_user'
